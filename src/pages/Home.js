  ...
  return (
    <div className="flex flex-col">
      <>
                  ...
                  <div className="single-schedule first">
                    <div className="inner">
                      ...
                      <div className="single-content">
                        <h4>mission</h4>
                        <p>
                          To facilitate effective intergovernmental relations
                          for consolidating and deepening devolution through
                          consultation, cooperation, and coordination to achieve
                  ...
                  <div className="col-lg-12 col-12">
                    ...
                    <div className="choose-left">
                      ...
                      <p>
                        ...
                        intergovernmental relations (IGR) and disseminate
                        critical information on devolution in Kenya. Together,
                        these platforms will support research, dispute
                        resolution, public awareness, and informed
                        decision-making processes.
                      </p>
                      <h3>Main objective</h3>
                      <p>
                        To create a vibrant, modern Resource Centre and online
                        portal that will provide comprehensive support for IGR
                        institutions and enhance understanding of devolution in
                        Kenya.
                      </p>
                      <div className="row">
                        ...
                        <div className="col-lg-6">
                          <ul className="list">
                            <li>
                              <i className="fa fa-caret-right" />
                              Enhanced Public Awareness and Information
                              Accessibility{" "}
                            </li>
                          </ul>
                        </div>
        ...
        <section className="Features section">
          <main role="main" className="vundi">
            <div className="pt-0 pb-0 m-5 bg-white text-danger text-center">
              <h1>
                <p className="text-danger text-3xl">Devolution Stories</p>
              </h1>
            </div>
            <div className="container">
              ...
              <div className="col-lg-4 col-md-6 col-12">
                <div className="single-news">
                  <iframe
                    ...
                    alt="devolution"
                  />
                  <p style={{ textAlign: "center" }}>Transfer of functions </p>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="single-news">
        ...
        <div className="marqueestyle py-4 container">
              ...
              <div className="col-lg-6  col-12">
                ...
                <div className="subscribe-form ">
                  <form
                    ...
                    method="get"
                    target="_blank"
                    className="newsletter-inner flex"
                  >
                    <input
                      name="EMAIL"
