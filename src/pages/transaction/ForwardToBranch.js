  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.Response === '000') {
        ...
        history.push('/app/list-transactions');
      } else {
        setLoading(false);
      ...
      setLoading(false);
      toast.error('Forward To Branch Failure: ' + error);
    }
  };
...
export default ForwardToBranch;
